...
The purpose is to understand the working of [ZenML](zenml.io) and in turn learning about MLOps in general. [ZenML](zenml.io) empowers your business to build and deploy machine learning pipelines in a multitude of ways:
